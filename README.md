...
1. **Simple ($O(n^{2})$):** Düşük veri setleri veya düşük düzensizlik (disorder < 0.2) durumlarında **Insertion Sort** adaptasyonu kullanılır. Küçük yığınlarda en az operasyon sayısını hedefler.
...
| --- | --- |
| **nbulbul** | Algoritma geliştirmeleri: Insertion Sort, Chunk-based Sorting, Radix Sort. |
